...
struct UFoliageType : public UObject {
	...
	char VertexColorMask; // 0x98(0x01)
	...
	char UnknownData_149_1 : 7; // 0x149(0x01)
	...
	char CustomNavigableGeometry; // 0x268(0x01)
	...
	char UnknownData_26C_1 : 7; // 0x26c(0x01)
