...
struct UFieldSystemComponent : public UPrimitiveComponent {
	struct UFieldSystem* FieldSystem; // 0x430(0x08)
	char UnknownData_438[0x10]; // 0x438(0x10)
	struct TArray<struct TSoftObjectPtr<struct AChaosSolverActor>> SupportedSolvers; // 0x448(0x10)
