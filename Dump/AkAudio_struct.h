...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	...
	bool UseHardwareCodecLowLatencyMode; // 0x3c(0x01)
	char UnknownData_3D[0x3]; // 0x3d(0x03)
	uint32_t NumAudioOut2ObjectPorts; // 0x40(0x04)
};
...
struct FMovieSceneFloatChannelSerializationHelper {
	char PreInfinityExtrap; // 0x00(0x01)
	char PostInfinityExtrap; // 0x01(0x01)
...
struct FMovieSceneFloatValueSerializationHelper {
	...
	char InterpMode; // 0x04(0x01)
	char TangentMode; // 0x05(0x01)
...
struct FMovieSceneTangentDataSerializationHelper {
	...
	char TangentWeightMode; // 0x08(0x01)
	char UnknownData_9[0x3]; // 0x09(0x03)
