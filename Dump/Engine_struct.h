...
struct FParticleCollisionPackedParams {
	...
	float EmitterTime; // 0x08(0x04)
	int32_t ParticleTime; // 0x0c(0x04)
	struct FVector Location; // 0x10(0x0c)
	struct FVector Velocity; // 0x1c(0x0c)
	struct FVector Direction; // 0x28(0x0c)
	struct FVector Normal; // 0x34(0x0c)
	struct FName BoneName; // 0x40(0x08)
	struct UPhysicalMaterial* PhysMat; // 0x48(0x08)
	struct UParticleSystemComponent* Source; // 0x50(0x08)
};
...
struct FAnimBlueprintFunctionData {
	FieldPathProperty OutputPoseNodeProperty; // 0x00(0x28)
	struct TArray<FieldPathProperty> InputPoseNodeProperties; // 0x28(0x10)
	struct TArray<FieldPathProperty> InputProperties; // 0x38(0x10)
};
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base {
	...
	int8_t UseCount; // 0x2c(0x01)
	char UnknownData_2D[0x8b]; // 0x2d(0x8b)
};
...
struct FExposedValueHandler {
	...
	FieldPathProperty ValueHandlerNodeProperty; // 0x20(0x28)
...
struct FExposedValueCopyRecord {
	...
	FieldPathProperty DestProperty; // 0x18(0x28)
	int32_t DestArrayIndex; // 0x40(0x04)
	int32_t Size; // 0x44(0x04)
	FieldPathProperty CachedSourceProperty; // 0x48(0x28)
	FieldPathProperty CachedSourceStructSubProperty; // 0x70(0x28)
};
...
struct FMeshBuildSettings {
	...
	char bSmoothNormalsInVertexColor : 1; // 0x00(0x01)
	char bUseHighPrecisionTangentBasis : 1; // 0x01(0x01)
	...
	char UnknownData_1_5 : 3; // 0x01(0x01)
	char UnknownData_2[0x2]; // 0x02(0x02)
...
struct FLightmassLightSettings {
	...
	bool bExcludeFromVolumetricLightmap; // 0x09(0x01)
	char UnknownData_A[0x2]; // 0x0a(0x02)
};
...
struct FHirezObjectPool {
	struct TMap<struct UObject*, struct FHirezObjectPoolItem> PoolsByClass; // 0x00(0x50)
	struct TArray<struct FHirezObjectPoolQueuedEntry> QueuedEntries; // 0x50(0x10)
	char UnknownData_60[0x8]; // 0x60(0x08)
};
...
struct FHirezObjectPoolQueuedEntry {
	int32_t FramesLeft; // 0x00(0x04)
	char UnknownData_4[0x4]; // 0x04(0x04)
	struct UObject* MyClass; // 0x08(0x08)
	struct FName MyName; // 0x10(0x08)
};

// ScriptStruct Engine.HirezObjectPoolItem
// Size: 0x10 (Inherited: 0x00)
struct FHirezObjectPoolItem {
	struct TArray<struct FName> FreeNames; // 0x00(0x10)
};
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	char bOverride_MaterialSSR : 1; // 0x00(0x01)
	char MaterialSSR : 1; // 0x00(0x01)
	char bOverride_HQForwardReflections : 1; // 0x01(0x01)
	char HQForwardReflections : 1; // 0x01(0x01)
...
struct FMeshMergingSettings {
	...
	char UnknownData_9D_3 : 5; // 0x9d(0x01)
	bool bPivotPointAtRoot; // 0x9e(0x01)
	bool bAverageRootLocationsForFinalPivot; // 0x9f(0x01)
	bool bSplitForComplexity; // 0xa0(0x01)
	...
	char bUseTextureBinning : 1; // 0xa1(0x01)
	char bReuseMeshLightmapUVs : 1; // 0xa1(0x01)
	char bMergeEquivalentMaterials : 1; // 0xa1(0x01)
	char bUseLandscapeCulling : 1; // 0xa2(0x01)
	char bIncludeImposters : 1; // 0xa2(0x01)
	char bAllowDistanceField : 1; // 0xa2(0x01)
	char UnknownData_A2_3 : 5; // 0xa2(0x01)
...
struct FParticleChannelContainer {
	char Default : 1; // 0x00(0x01)
	char Friendly : 1; // 0x00(0x01)
	char Enemy : 1; // 0x00(0x01)
	char TaskForce1 : 1; // 0x00(0x01)
	char TaskForce2 : 1; // 0x00(0x01)
	char UnknownData_0_5 : 3; // 0x00(0x01)
	char VerticalTargeter : 1; // 0x01(0x01)
	char LocalOwner : 1; // 0x01(0x01)
	char NotLocalOwner : 1; // 0x01(0x01)
	char UnknownData_1_3 : 5; // 0x01(0x01)
	char CustomFilter1 : 1; // 0x02(0x01)
	char CustomFilter2 : 1; // 0x02(0x01)
	char CustomFilter3 : 1; // 0x02(0x01)
	char CustomFilter4 : 1; // 0x02(0x01)
	char CustomFilter5 : 1; // 0x02(0x01)
	char UnknownData_2_5 : 3; // 0x02(0x01)
	char UnknownData_3[0x1]; // 0x03(0x01)
};
...
// Size: 0x50 (Inherited: 0x00)
struct FTouchRegion {
	float NormalizedX; // 0x00(0x04)
	float NormalizedY; // 0x04(0x04)
	float NormalizedWidth; // 0x08(0x04)
	float NormalizedHeight; // 0x0c(0x04)
	float MaxFullAxisLengthOverride; // 0x10(0x04)
	float MaxFullAxisDeadZoneLengthOverride; // 0x14(0x04)
	char UnknownData_18[0x38]; // 0x18(0x38)
};
...
struct FTouchRegionTouchData {
	char UnknownData_0[0x158]; // 0x00(0x158)
};
...
struct FSkeletalMeshLODGroupSettings {
	...
	struct FPerPlatformBool bUseExtraBonesToRemove; // 0x20(0x01)
	char UnknownData_21[0x7]; // 0x21(0x07)
	struct TArray<struct FBoneFilter> ExtraBonesToRemove; // 0x28(0x10)
	struct TArray<struct FName> BonesToPrioritize; // 0x38(0x10)
	float WeightOfPrioritization; // 0x48(0x04)
	char UnknownData_4C[0x4]; // 0x4c(0x04)
	struct UAnimSequence* BakePose; // 0x50(0x08)
	struct FSkeletalMeshOptimizationSettings ReductionSettings; // 0x58(0x3c)
...
struct FSoundClassProperties {
	...
	char bApplyInsulationVolumes : 1; // 0x2c(0x01)
	char UnknownData_2C_1 : 7; // 0x2c(0x01)
	char UnknownData_2D[0x3]; // 0x2d(0x03)
	char OutputTarget; // 0x30(0x01)
	enum class ESoundWaveLoadingBehavior LoadingBehavior; // 0x31(0x01)
	char UnknownData_32[0x6]; // 0x32(0x06)
	struct USoundSubmix* DefaultSubmix; // 0x38(0x08)
...
struct FHierarchicalSimplification {
	...
	struct FMeshMergingSettings MergeSetting; // 0xb4(0xa4)
	float DesiredBoundRadius; // 0x158(0x04)
	float DesiredFillingPercentage; // 0x15c(0x04)
	int32_t MinNumberOfActorsToBuild; // 0x160(0x04)
};
...
struct FLightmassWorldInfoSettings {
	...
	bool bEnableGpuLightmass; // 0x4c(0x01)
	char UnknownData_4D[0x3]; // 0x4d(0x03)
	int32_t NumPrimaryGISamples; // 0x50(0x04)
	int32_t NumSecondaryGISamples; // 0x54(0x04)
	float FireflyClampingThreshold; // 0x58(0x04)
};
