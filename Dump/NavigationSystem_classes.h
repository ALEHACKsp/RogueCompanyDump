...
struct UNavigationGraphNodeComponent : public USceneComponent {
	struct FNavGraphNode Node; // 0x208(0x18)
	struct UNavigationGraphNodeComponent* NextNodeComponent; // 0x220(0x08)
	struct UNavigationGraphNodeComponent* PrevNodeComponent; // 0x228(0x08)
};
...
struct UNavLinkComponent : public UPrimitiveComponent {
	...
	struct TArray<struct FNavigationLink> Links; // 0x438(0x10)
