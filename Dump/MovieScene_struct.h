...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase {
	...
	struct FWeakObjectPtr<struct UMovieSceneSection> SourceSectionPtr; // 0x14(0x08)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel {
	char PreInfinityExtrap; // 0x08(0x01)
	char PostInfinityExtrap; // 0x09(0x01)
...
struct FMovieSceneFloatValue {
	...
	char InterpMode; // 0x18(0x01)
	char TangentMode; // 0x19(0x01)
...
struct FMovieSceneTangentData {
	...
	char TangentWeightMode; // 0x10(0x01)
	char UnknownData_11[0x3]; // 0x11(0x03)
};
...
struct FMovieSceneSequenceReplProperties {
	...
	char LastKnownStatus; // 0x08(0x01)
	char UnknownData_9[0x3]; // 0x09(0x03)
