...
struct UNiagaraComponent : public UFXSystemComponent {
	struct UNiagaraSystem* Asset; // 0x430(0x08)
	enum class ENiagaraTickBehavior TickBehavior; // 0x438(0x01)
	char UnknownData_439[0x7]; // 0x439(0x07)
	struct FNiagaraUserRedirectionParameterStore OverrideParameters; // 0x440(0x108)
	char bForceSolo : 1; // 0x548(0x01)
	char UnknownData_548_1 : 7; // 0x548(0x01)
	char UnknownData_549[0x2b]; // 0x549(0x2b)
	char bAutoDestroy : 1; // 0x574(0x01)
	char bRenderingEnabled : 1; // 0x574(0x01)
	char bAutoManageAttachment : 1; // 0x574(0x01)
	char bAutoAttachWeldSimulatedBodies : 1; // 0x574(0x01)
	char UnknownData_574_4 : 4; // 0x574(0x01)
	char UnknownData_575[0x3]; // 0x575(0x03)
	float MaxTimeBeforeForceUpdateTransform; // 0x578(0x04)
	char UnknownData_57C[0x4]; // 0x57c(0x04)
	struct FMulticastInlineDelegate OnSystemFinished; // 0x580(0x10)
	...
	char UnknownData_5A3[0x3d]; // 0x5a3(0x3d)
